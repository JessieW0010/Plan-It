            ...
            <View style={styles.cardContainer}>
              ...
              <View style={styles.detailContainer}>
                  ...
                  <View style={styles.cardTextContainer}>
                    <Text style={styles.infoText}>{e.borrower_first_name} {e.borrower_last_name}</Text>
                    <Text style={styles.infoText}> owes you</Text>
                    <Text style={[styles.infoText, {fontWeight: "bold"}]}> ${parseFloat(e.amount_owed_in_cents/100)}</Text>
                  </View>
                  }
                   {(user == e.borrower_id) && 
                  <View style={styles.cardTextContainer}>
              ...
              <View style={styles.paidBtnContainer}>
                <TouchableOpacity 
                  onPress={()=>{onUpdate(e.transaction_id)}}
